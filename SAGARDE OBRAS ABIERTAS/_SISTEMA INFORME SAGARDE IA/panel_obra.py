...
.bento-health{background:var(--card);border:1px solid color-mix(in srgb,var(--muted) 24%,transparent);border-radius:var(--radius);padding:13px 16px;box-shadow:0 1px 3px color-mix(in srgb,var(--header) 8%,transparent);margin-bottom:11px;}
.bento-health-top{display:flex;align-items:flex-start;justify-content:space-between;gap:18px;margin-bottom:10px;}
.bento-eyebrow{display:block;color:var(--accent2);font-size:10px;font-weight:800;letter-spacing:1.25px;text-transform:uppercase;margin-bottom:2px;}
.bento-health h2{font-size:15.5px;line-height:1.2;}.bento-health-meta{color:var(--muted);font-size:11px;margin-top:2px;}
.bento-health-side{display:flex;align-items:stretch;gap:10px;flex:0 0 auto;}
.bento-stat{min-width:108px;text-align:right;padding-left:10px;border-left:1px solid color-mix(in srgb,var(--muted) 24%,transparent);}
.bento-stat strong{display:block;color:var(--header);font-size:21px;line-height:1.05;}.bento-stat span{display:block;color:var(--muted);font-size:10px;margin-top:2px;}
.bento-attention{display:flex;flex-direction:column;justify-content:center;max-width:355px;padding:7px 11px;border-radius:8px;border:1px solid color-mix(in srgb,var(--warn) 34%,transparent);background:color-mix(in srgb,var(--warn) 8%,var(--card));color:var(--warn);}
...
.bento-attention strong{font-size:11px;text-transform:uppercase;letter-spacing:.55px;}.bento-attention span{font-size:10px;line-height:1.3;margin-top:1px;color:var(--text);}
.bento-segments{display:flex;min-height:10px;border-radius:20px;overflow:hidden;background:color-mix(in srgb,var(--muted) 12%,var(--card));}
.bento-segment{display:block;min-width:0;}.bento-segment+.bento-segment{box-shadow:-2px 0 0 var(--card);}
.bento-legend{display:grid;grid-template-columns:repeat(6,minmax(0,1fr));gap:6px;margin-top:8px;}
.bento-legend-item{text-align:center;min-width:0;}.bento-legend-label{display:flex;align-items:center;justify-content:center;gap:5px;color:var(--muted);font-size:10px;line-height:1.15;}
.bento-dot{display:inline-block;width:7px;height:7px;border-radius:50%;flex:0 0 auto;background:var(--bento-color);}.bento-legend-item strong{display:block;color:var(--bento-color);font-size:14px;margin-top:2px;}
.bento-grid{display:grid;grid-template-columns:repeat(12,minmax(0,1fr));grid-auto-rows:minmax(92px,auto);gap:11px;}
.bento-link{color:inherit;text-decoration:none;}.bento-card{--bento-color:var(--muted);display:flex;flex-direction:column;min-width:0;background:var(--card);border:1px solid color-mix(in srgb,var(--muted) 24%,transparent);border-left:4px solid var(--bento-color);border-radius:var(--radius);padding:12px 14px;box-shadow:0 1px 3px color-mix(in srgb,var(--header) 8%,transparent);transition:transform .15s ease,box-shadow .15s ease,border-color .15s ease;}
...
.bento-hero{grid-column:span 8;--bento-color:var(--ok);padding:15px 17px;}
.bento-small{grid-column:span 4;}.bento-third{grid-column:span 4;}
.bento-card-kicker{display:flex;align-items:center;gap:6px;color:var(--bento-color);font-size:10px;font-weight:800;letter-spacing:.75px;text-transform:uppercase;}
.bento-card h3{font-size:13.5px;margin-top:5px;}.bento-hero h3{font-size:18px;margin-top:4px;}.bento-card-copy{color:var(--muted);font-size:11px;margin-top:2px;}
.bento-number{color:var(--bento-color);font-size:27px;font-weight:800;line-height:1;margin-top:auto;padding-top:7px;}.bento-number-label{color:var(--muted);font-size:10px;margin-top:2px;}
.bento-hero-head{display:flex;justify-content:space-between;gap:16px;align-items:flex-start;}.bento-hero-total{text-align:right;flex:0 0 auto;}.bento-hero-total strong{display:block;color:var(--ok);font-size:32px;line-height:1;}.bento-hero-total span{display:block;color:var(--muted);font-size:10px;margin-top:2px;}
.bento-breakdown{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:8px;margin-top:auto;padding-top:12px;}.bento-breakdown-item{--bento-color:var(--muted);padding:8px 10px;border:1px solid color-mix(in srgb,var(--bento-color) 24%,transparent);border-radius:8px;background:color-mix(in srgb,var(--bento-color) 6%,var(--card));}.bento-breakdown-item span{display:block;color:var(--muted);font-size:10px;text-transform:uppercase;letter-spacing:.45px;}.bento-breakdown-item strong{display:block;color:var(--bento-color);font-size:19px;line-height:1.1;margin-top:2px;}
.bento-reference{margin-top:11px;padding:12px 14px;border:1px solid color-mix(in srgb,var(--muted) 24%,transparent);border-radius:var(--radius);background:color-mix(in srgb,var(--muted) 5%,var(--card));}.bento-reference-title{color:var(--muted);font-size:10px;font-weight:800;letter-spacing:1px;text-transform:uppercase;margin-bottom:7px;}.bento-chips{display:flex;flex-wrap:wrap;gap:6px;}
.bento-chip{--bento-color:var(--muted);display:inline-flex;align-items:center;gap:7px;padding:6px 10px;background:var(--card);border:1px solid color-mix(in srgb,var(--muted) 25%,transparent);border-left:3px solid var(--bento-color);border-radius:8px;color:var(--text);font-size:11.5px;font-weight:650;text-decoration:none;transition:transform .15s ease,box-shadow .15s ease,border-color .15s ease;}
...
def bloque_prioridades_partes(prioridades, tareas_manual=None,
    ...
    <section class="bento-command" aria-label="Centro de mando de prioridades">
      ...
      <div class="bento-grid">
        ...
        <a class="bento-link bento-card bento-third indice-nav-link" style="--bento-color:{'var(--warn)' if n_preguntas else 'var(--ok)'};" href="#{_ID_SEC_DUDAS}" data-abre="{_ID_SEC_DUDAS}">
