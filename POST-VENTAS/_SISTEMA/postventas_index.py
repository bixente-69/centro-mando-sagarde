...
def write_preview(docx_path: Path) -> tuple[Path | None, int, int]:
    ...
    # El preview vive en POST-VENTAS/_SISTEMA/_PREVIEWS_WORD/, dos niveles por
    # debajo de POST-VENTAS. url_for() da la ruta relativa a POST-VENTAS, asi
    # que desde aqui hacen falta DOS "../", no uno. Con uno solo los dos
    # botones del preview apuntarian dentro de _SISTEMA y no darian error:
    # simplemente no abririan nada.
